...
const Experience = () => {
  ...
  const timeline = [
    {
      date: 'Now',
      title: 'Building Next-Gen AI Projects',
      description: 'Currently developing advanced AI/ML applications and exploring LLM integrations',
      status: 'active',
      tags: ['AI', 'LLM', 'React']
    },
    {
      date: 'Now',
      title: 'NumPy',
      description: 'Exploring efficient numerical computing and data manipulation with Python',
      status: 'active',
      tags: ['Python']
    },
    {
      date: '',
      title: 'AI Chat App',
      description: 'A real-time AI chat application built with FastAPI and streaming responses.',
      status: 'milestone',
      tags: ['FastAPI','SQLite']
    },
    {
      ...
      description: 'Educational platform with voice synthesis and live tutorials',
      status: 'completed',
    ...
    },
    {
      ...
      description: 'Full-stack ordering system with admin dashboard',
      status: 'milestone',
          ...
          <div className="space-y-4">
            {timeline.map((item, index) => {
              ...
              return (
                ...
                >
                  <div className={`absolute left-6 w-5 h-5 rounded-full border-4 border-gray-900 transition-all duration-300 ${
                    isActive 
                  ...
                  <div 
                    className={`backdrop-blur-sm rounded-2xl p-3 border transition-all duration-300 ${
                      isActive 
                  ...
                  >
                    <div className="flex items-center gap-2 mb-1">
                      <span className={`text-xs font-semibold transition-colors ${
                        isActive ? 'text-green-400' : isInFocus ? 'text-purple-400' : 'text-gray-500'
                      }`}>{item.date}</span>
                      {isActive && (
                    ...
                    <p className={`text-gray-400 text-xs mb-2 leading-relaxed transition-all duration-300 ${
                      isInFocus ? 'text-gray-300' : ''
                    }`}>
                      {item.description}
                    </p>
                  ...
                  <div 
                    className={`absolute left-8 top-8 w-8 h-px transition-all duration-300 ${
                      isActive 
